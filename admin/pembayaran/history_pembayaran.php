...
$users = query("SELECT * FROM tb_pembayaran JOIN tb_siswaku on tb_pembayaran.nisn=tb_siswaku.nisn 
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="content">
                ...
                <section>
                    <a href="pembayaran.php" class="add">Bayar</a>
                    <a href="cetak2.php" class="add" target="_blank">Print</a>
