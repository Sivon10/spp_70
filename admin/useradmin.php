...
if (isset($_POST['cari'])) {
    $users = cariKelas($_POST['kataKunci']);
}
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <table border="0" cellpadding="10" cellspacing="0">
                        ...
                        <?php foreach ($users as $user) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="delete.php?id=<?= $user["id_kelas"]; ?>" class="delete">Hapus</a> | <a href="edit.php?id=<?= $user["id_kelas"]; ?>" class="edit">Edit</a>
                                </td>
                                </td>
                            </tr>
                            <?php $i++; ?>
...
<!-- <?php
        if (isset($_GET['cari'])) {
            $cari = $_GET['cari'];
            $data = query("select * from tb_kelas where nama_kelas like '%" . $cari . "%'");
        } else {
