                    ...
                    <table border="0" cellpadding="10" cellspacing="0">
                        ...
                        <?php foreach ($users as $user) : ?>
                            <tr>
                                ...
                                <td><?= $user["nominal"]; ?></td>
                                <td>
                                    <a href="hapus_spp.php?id=<?= $user["id_spp"]; ?>" class="delete">Hapus</a> | <a href="edit_spp.php?id=<?= $user["id_spp"]; ?>" class="edit">Edit</a>
                                </td>
                                </td>
                            </tr>
                            <?php $i++; ?>
